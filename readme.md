...
docker build -t system-rest .

# Run the container
docker run -p 9966:9966 system-rest
```
...
- Frontend: [system-vue](https://github.com/YOUR_USERNAME/system-vue)
...
- `SERVER_SERVLET_CONTEXT_PATH`: Context path for the application (default: `/petclinic`)
